...
`spectra.visual` is a mini-database and R data package of receptor absorbance and ocular transmission spectra with metadata, useful for visual/colorspace modelling among other things. It currently contains **`r spectra` spectra** from **`r species` species**.
